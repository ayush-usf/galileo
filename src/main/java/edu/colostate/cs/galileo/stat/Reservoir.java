...
public class Reservoir<T> {
    ...
    public static void main(String[] args) {
        ...
        Reservoir<Double> r2 = new Reservoir<>(5);

        Random r = new Random();
        r.doubles(10000).forEach(rs::put);
        r.doubles(10000).forEach(r2::put);
        ...
        Reservoir<Double> z = new Reservoir<Double>(Arrays.asList(rs, r2));
